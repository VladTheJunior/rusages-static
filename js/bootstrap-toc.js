	...
	(window.Toc = {
		helpers: {
			...
			createNavList: function () {
				return a('<ol class="article-toc-body"></ol>');
			},
			...
			generateNavEl: function (e, t) {
				var n = a('<a class="notanimated-link-white"></a>');
				n.attr("data-id", "#" + e), n.text(t);
				var r = a("<li class='article-toc-item'></li>");
				return r.append(n), r;
			},
		...
		a(function () {
			a('div[data-toggle="toc"]').each(function (e, t) {
				var n = a(t);
				Toc.init(n);
			});
		});
